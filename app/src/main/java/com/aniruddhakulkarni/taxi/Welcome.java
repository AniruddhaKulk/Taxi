...
public class Welcome extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    private static final int LOCATION_REQ_CODE = 7000;
    private static final int PLAY_SERVICE_RESOLUTION_REQ = 7001;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                destination = edLocation.getText().toString();
                    ...
                    .enqueue(new Callback<String>() {
                        ...
                        public void onResponse(Call<String> call, Response<String> response) {
                            try{
                                ...
                                handler.postDelayed(drawPathRunnable, 1000);
                        ...
                        public void onFailure(Call<String> call, Throwable t) {
                            Toast.makeText(Welcome.this, "Error getting direction " + t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }catch (Exception e){
            e.printStackTrace();
